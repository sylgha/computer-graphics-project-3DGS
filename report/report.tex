...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.3\linewidth]{../screenshots/bird_mesh103.png}
	\hfill
	\includegraphics[width=0.3\linewidth]{../screenshots/toy_mesh100.png}
	\hfill
	\includegraphics[width=0.3\linewidth]{../screenshots/bird_mesh204.png}
	\caption{Mesh 重建结果展示：(左) Bird 103，(中) Toy 100，(右) Bird 204}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=0.3\linewidth]{../screenshots/toy_mesh201.png}
	\hfill
	\includegraphics[width=0.3\linewidth]{../screenshots/bird_model00.png}
	\hfill
	\includegraphics[width=0.3\linewidth]{../screenshots/toy_model103.png}
	\caption{重建与模型可视化：(左) Toy 201，(中) Bird 模型 00，(右) Toy 模型 103}
\end{figure}
