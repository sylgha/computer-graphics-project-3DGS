...
execute_process(
  COMMAND "/usr/bin/git" show-ref "7a20a9ac0a1d34850fc3a9e398fc4a7618e8a69a"
  WORKING_DIRECTORY "/root/autodl-tmp/gaussian-splatting/SIBR_viewers/extlibs/nanoflann/nanoflann"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/autodl-tmp/gaussian-splatting/SIBR_viewers/extlibs/nanoflann/nanoflann'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/root/autodl-tmp/gaussian-splatting/SIBR_viewers/extlibs/nanoflann/nanoflann'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
