...
execute_process(
  COMMAND "/usr/bin/git" show-ref "069e87f5ec5ce1745253bd64d89644d6b894e516"
  WORKING_DIRECTORY "/root/autodl-tmp/gaussian-splatting/SIBR_viewers/extlibs/rapidxml/rapidxml"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/autodl-tmp/gaussian-splatting/SIBR_viewers/extlibs/rapidxml/rapidxml'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/root/autodl-tmp/gaussian-splatting/SIBR_viewers/extlibs/rapidxml/rapidxml'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
