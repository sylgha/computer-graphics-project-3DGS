...
execute_process(
  COMMAND "/usr/bin/git" show-ref "ae2fab73cf44bebdc08d997e307c8df30bb9acec"
  WORKING_DIRECTORY "/root/autodl-tmp/gaussian-splatting/SIBR_viewers/extlibs/nativefiledialog/nativefiledialog"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/autodl-tmp/gaussian-splatting/SIBR_viewers/extlibs/nativefiledialog/nativefiledialog'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/root/autodl-tmp/gaussian-splatting/SIBR_viewers/extlibs/nativefiledialog/nativefiledialog'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
