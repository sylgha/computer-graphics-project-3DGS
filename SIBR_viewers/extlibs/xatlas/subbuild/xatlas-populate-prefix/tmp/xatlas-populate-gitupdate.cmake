...
execute_process(
  COMMAND "/usr/bin/git" show-ref "0fbe06a5368da13fcdc3ee48d4bdb2919ed2a249"
  WORKING_DIRECTORY "/root/autodl-tmp/gaussian-splatting/SIBR_viewers/extlibs/xatlas/xatlas"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/autodl-tmp/gaussian-splatting/SIBR_viewers/extlibs/xatlas/xatlas'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/root/autodl-tmp/gaussian-splatting/SIBR_viewers/extlibs/xatlas/xatlas'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
